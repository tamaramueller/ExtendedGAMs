...
# %%
# calculate CCNS for weighted graphs
ccns_continuous = gams.get_cross_class_neighbourhood_similarity_continuous(adj_matrix_continuous, labels_classification)
print(ccns_continuous)
# %%
# calculate CCNS distance for weighted graphs
ccns_distance_continuous = gams.get_ccns_distance(ccns_continuous)
print("CCNS distance for weighted graphs: ", ccns_distance_continuous.item())
